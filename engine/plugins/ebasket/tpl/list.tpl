<div class="frame-inside page-cart pageCart">
    <div class="container">
        <div class="js-empty empty ">
            ...
            <form method="post" action="/plugin/ebasket/" class="clearfix">
                <div class="left-cart">
                    {% if (formEntry.notify) %}
                    <div class="f-s_0 title-order-view without-crumbs">
                        <div class="frame-title">
                            <h1 class="title">Заказ №:<span class="number-order">XXX</span></h1>
                        </div>
                    </div>
                            ...
                            <div class="groups-form">
                                <label>
                                    ...
                                    <span class="frame-form-field">
                                        <input type="text" value="" name="userInfo[fullName]">
                                    </span>
                                </label>
                                <label>
                                    <span class="title">
                                    ...
                                    <span class="frame-form-field">
                                        <input type="text" value="" name="userInfo[email]">
                                    </span>
                                </label>
                                <label>
                                 <span class="title">
                               ...
                               <span class="frame-form-field">
                                <input type="text" name="userInfo[phone]" id="cart-phone" value="" class="">
                            </span>
                        </label>
                    ...
                    <div class="groups-form">
                       ...
                       <label>
                        ...
                        <span class="frame-form-field">
                            <input name="userInfo[deliverTo]" type="text" value="">
                        </span>
                    </label>
