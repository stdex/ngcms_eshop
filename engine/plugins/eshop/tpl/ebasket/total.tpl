            ...
            <span class="text-cleaner">
                ...
                <span class="">
                    ...
                    <span class="d_b" style="padding-top:3px;">
                        ...
                        <span class="d_i-b"><span class="text-el" id="basket_price">{{ (price * system_flags.eshop.current_currency.rate_from)|number_format(2, '.', '') }}</span><span class="text-el" id="basket_price"> {{ system_flags.eshop.current_currency.sign }}</span></span>
                    </span>
                    {% else %}
                    <span class="d_b" style="padding-top:3px;">
