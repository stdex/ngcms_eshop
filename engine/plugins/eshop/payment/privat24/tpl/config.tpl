...
<td class="contentEntry2" valign=top><input name="merchantid" type="text" size="100" value="{{entries.options.merchantid}}" /></td>
</tr>
<tr>
<td class="contentEntry1" valign=top>Пароль<br /></td>
<td class="contentEntry2" valign=top><input name="merchantpass" type="text" size="100" value="{{entries.options.merchantpass}}" /></td>
</tr>
</table>
</fieldset>
